...
that is always in effect. At 1.0.0 that doctrine is the integrated material
and `references/` is empty; `SKILL.md` is the authoritative list of what is
loadable. The Django backend itself is out of scope.

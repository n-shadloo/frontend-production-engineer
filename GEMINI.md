...
At 1.2.1 the integrated material is that doctrine, the App Router foundation,
the type system, and the React component tree in `references/`. `SKILL.md` is
the authoritative list of what is loadable.
